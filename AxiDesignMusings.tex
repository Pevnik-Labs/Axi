...
\begin{itemize}
  ...
  \item How much? Maybe the cost can be amortized over the cost of execution?
...
\begin{frame}{Complexity of type checking}
...
\begin{frame}{Big table}

\begin{itemize}
  \item STLC without annotations: inference and checking equivalent and PTIME-complete.
  \item Intrinsic STLC: inference in linear time, so checking too.
  \item Dual Intrinsic STLC: checking in linear time, inference probably still PTIME-complete.
  \item System F without annotations: inference and checking equivalent and undecidable.
  \item System F with annotations: should still be linear time.
  \item CoC without annotations: checking and inference undecidable.
  \item CoC with enough annotations: decidable, but arbitrarily complex (we might need to run programs at type level).
\end{itemize}
...
\begin{table}
  ...
  \begin{tabular}{|c|c|c|c|}
      \hline
      & Checking & Inference 2 & Column 3 \\ \hline
      STLC without annotations & Data 1   & Data 2   & Data 3   \\ \hline
      STLC with annotations    & Data 4   & Data 5   & Data 6   \\ \hline
  \end{tabular}
