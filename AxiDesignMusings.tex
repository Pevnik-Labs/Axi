...
\begin{frame}{What is termination checking?}

Termination checking is the following task: we are given the definition of a well-typed function $f : A \to B$ and we need to tell whether it terminates or not.
