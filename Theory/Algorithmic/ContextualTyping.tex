...
\begin{center}
  ...
  $\infrule{\divctx{\Gamma}{r} = (\Gamma_1, \Gamma_2) \quad \infer{\Gamma_1}{A}{e}{A'}{\Gamma_3} \quad \compat{\addctx{\Gamma_2}{\scalectx{r}{\Gamma_3}}}{\Sigma}{B}{\Gamma_4}}{\compat{\Gamma}{\arghint{\Sigma}{e}}{\Fun[r]{A}{B}}{\Gamma_4}}$
\end{center}
...
\begin{center}
  $\infrule{\infer{\Gamma}{\arghint{\Sigma}{e_2}}{e_1}{\Fun[r]{A}{B}}{\Gamma'}}{\infer{\Gamma}{\Sigma}{\app{e_1}{e_2}}{B}{\Gamma'}}$

  \vspace{2em}

  $\infrule{\infer{\extend{\Gamma}[\totalqty{r}{A}]{x}{A}}{B}{e}{B'}{\extend{\Gamma'}[\Zero]{x}{A}}}{\infer{\Gamma}{\typehint{\Fun[r]{A}{B}}}{\fun{x}{e}}{\Fun[r]{A}{B'}}{\Gamma'}}$

  \vspace{2em}

  $\infrule{\begin{array}{l} \divctx{\Gamma}{r} = (\Gamma_1, \Gamma_2) \quad \infer{\Gamma_1}{\emptyhint}{e'}{A}{\Gamma_3} \\ \infer{\extend{(\addctx{\Gamma_2}{\scalectx{r}{\Gamma_3}})}[\totalqty{r}{A}]{x}{A}}{\Sigma}{e}{B}{\extend{\Gamma_4}[\Zero]{x}{A}} \end{array}}{\infer{\Gamma}{\arghint{\Sigma}{e'}}{\fun[r]{x}{e}}{\Fun[r]{A}{B}}{\Gamma_4}}$
\end{center}

\end{frame}

\begin{frame}{Inferring quantities}

\begin{center}
  $\infrule{\begin{array}{l} \infer{\Gamma}{\emptyhint}{e'}{A}{\Gamma'} \quad \infer{\extend{\Gamma}[-\Zero]{x}{A}}{\Sigma}{e}{B}{\extend{\Gamma_1}[-r']{x}{A}} \\ \subusage{\subqty{\totalqty{r}{A}}{r'}}{\Zero} \quad \divctx{\Gamma_1}{r} = (\Gamma_2, \Gamma_3) \quad \infer{\Gamma_2}{\emptyhint}{e'}{A}{\Gamma_4} \end{array}}{\infer{\Gamma}{\arghint{\Sigma}{e'}}{\fun{x}{e}}{\Fun[r]{A}{B}}{\addctx{\Gamma_3}{\scalectx{r}{\Gamma_4}}}}$

  \vspace{2em}

  $\infrule{\begin{array}{l} \infer{\Gamma}{\emptyhint}{e'}{A}{\Gamma_1} \quad \infer{\extend{\Gamma}[-\Zero]{x}{A}}{\Sigma}{e}{B}{\extend{\Gamma_2}[-r']{x}{A}} \\ \subusage{\subqty{\totalqty{r}{A}}{r'}}{\Zero} \end{array}}{\infer{\Gamma}{\arghint{\Sigma}{e'}}{\fun{x}{e}}{\Fun[r]{A}{B}}{\Gamma_2 - \scalectx{r}{(\Gamma -\Gamma_1)}}}$
\end{center}
...
\begin{center}
  ...
  $\infrule{\begin{array}{l} \infer{\Gamma}{\Sigma}{\emptyelim{e}}{\Fun[r]{A}{B}}{\Gamma_1} \\ \divctx{\Gamma_1} = (\Gamma_2, \Gamma_3) \quad \infer{\Gamma_2}{\typehint{A}}{e'}{A'}{\Gamma_4} \end{array}}{\infer{\Gamma}{\arghint{\Sigma}{e'}}{\emptyelim{e}}{\Fun[r]{A}{B}}{\addctx{\Gamma_3}{\scalectx{r}{\Gamma_4}}}}$
\end{center}
...
\begin{center}
  $\infrule{\infer{\Gamma}{\emptyhint}{e}{\Sum{A}{B}}{\Gamma_1} \quad \begin{array}{l} \infer{\Gamma_1}{\Sigma}{f}{\Fun[\One]{A}{C}}{\Gamma_2} \\ \infer{\Gamma_1}{\Sigma}{g}{\Fun[\One]{B}{C}}{\Gamma_3} \end{array}}{\infer{\Gamma}{\Sigma}{\case{e}{f}{g}}{C}{\lubctx{\Gamma_2}{\Gamma_3}}}$
