...
Whnfs: \\
$\hat{e} ::=$ \\
\qquad $n \pipe \fun[r]{x}{e} \pipe \boxintro[r]{e} \pipe \pair{e_1}{e_2} \pipe \inl{e} \pipe \inr{e} \pipe \unit$ \\
...
Neutral forms: \\
$n ::=$ \\
\qquad $x \pipe \app{n}{e} \pipe \tapp{n}{A} \pipe \itapp{n}{A} \pipe$ \\
\qquad $\unitelim{n}{e} \pipe \boxelim{x}{n}{e} \pipe$ \\
\qquad $\letpair{x}{y}{n}{e} \pipe \case{n}{e_1}{e_2} \pipe$ \\
\qquad $\choose{p} \pipe \choosewitnessp{x}{h}{p}{n}$

\vspace{2em}

Note that $\emptyelim{e}$ is neither whnf nor neutral.
...
$\reduction{e_1}{e_1'}$ -- single step \\
$\reductions{e_1}{e_1'}$ -- multi step

\end{frame}

\begin{frame}{Term conversion (all terms)}
...
\begin{center}
  ...
  $\infrule{}{\checktermconv{\Gamma}{\emptyelim{e_1}}{\emptyelim{e_2}}{A}{\Gamma'}}$
...
\begin{frame}{Term conversion (whnfs)}
...
\begin{frame}{Term conversion (neutral)}
...
\begin{center}
  $\infrule{\infertermconvwhnf{\Gamma}{n_1}{n_2}{\Unit}{\Gamma_1} \quad \infertermconv{\Gamma_1}{e_1}{e_2}{A}{\Gamma_2}}{\infertermconv{\Gamma}{\unitelim{n_1}{e_1}}{\unitelim{n_2}{e_2}}{A}{}}$

  \vspace{2em}

  $\infrule{\infertermconvwhnf{\Gamma}{n_1}{n_2}{\Box[r]{A}}{\Gamma_1} \quad \infertermconv{\extend{\Gamma_1}{x}{A}}{e_1}{e_2}{B}{\extend{\Gamma_2}{x}{A}}}{\infertermconv{\Gamma}{\boxelim{x}{n_1}{e_1}}{\boxelim{x}{n_2}{e_2}}{B}{\Gamma_2}}$

  \vspace{2em}

  $\infrule{\infertermconvwhnf{\Gamma}{n_1}{n_2}{\Prod{A}{B}}{\Gamma_1} \quad \infertermconv{\extend{\extend{\Gamma_1}{x}{A}}{y}{B}}{e_1}{e_2}{C}{\extend{\extend{\Gamma_2}{x}{A}}{y}{B}}}{\infertermconv{\Gamma}{\letpair{x}{y}{n_1}{e_1}}{\letpair{x}{y}{n_2}{e_2}}{C}{\Gamma_2}}$

  \vspace{2em}

  $\infrule{\infertermconv{\Gamma}{e_1}{e_2}{\Sum{A}{B}}{\Gamma_1} \quad \begin{array}{l} \infertermconv{\Gamma_1}{f_1}{f_2}{\Fun[\One]{A}{C}}{\Gamma_2} \\ \infertermconv{\Gamma_1}{g_1}{g_2}{\Fun[\One]{B}{C}}{\Gamma_3} \end{array}}{\infertermconv{\Gamma}{\case{e_1}{f_1}{g_1}}{\case{e_2}{f_2}{g_2}}{C}{\lubctx{\Gamma_2}{\Gamma_3}}}$
\end{center}
