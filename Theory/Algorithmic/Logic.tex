...
\begin{center}
  $\infrule[Subsumption]{\inferproof{\Gamma}{p}{P'}{\Gamma_1} \quad \checkpropconv{\Gamma_1}{P}{P'}{\Gamma_2}}{\checkproof{\Gamma}{p}{P}{\Gamma_2}}$

  \vspace{2em}

  $\infrule[Annot]{\checkprop{\Gamma}{P}{\Gamma_1} \quad \checkproof{\Gamma_1}{p}{P}{\Gamma_2}}{\inferproof{\Gamma}{\proving{P}{p}}{P}{\Gamma_2}}$
\end{center}
...
\begin{center}
  $\infrule{\checkprop{\Gamma}{P}{\Gamma_1} \quad \checkproof{\Gamma_1}{p}{P}{\Gamma_2} \quad \checkproof{\assume{\Gamma_2}{h}{P}}{q}{Q}{\assume{\Gamma_3}{h}{P}}}{\checkproof{\Gamma}{\lemma{h}{P}{p}{q}}{Q}{\Gamma_3}}$

  \vspace{2em}

  $\infrule{\checkprop{\Gamma}{P}{\Gamma_1} \quad \checkproof{\Gamma}{q}{\Impl{P}{Q}}{\Gamma_2} \quad \checkproof{\Gamma_2}{p}{P}{\Gamma_3}}{\checkproof{\Gamma}{\suffices{P}{q}{p}}{Q}{\Gamma_2}}$
\end{center}
...
\begin{center}
  $\infrule{\begin{array}{l} \inferproof{\Gamma}{p}{\Ex{x}[A]{P}}{\Gamma_1} \\ \checkproof{\assume{\extend{\Gamma}{y}{A}[\choose{p}]}{h}{\subst{P}{x}{y}}}{q}{Q}{\assume{\extend{\Gamma_2}{y}{A}[\choose{p}]}{h}{\subst{P}{x}{y}}} \end{array}}{\checkproof{\Gamma}{\choosewitnessl{y}{h}{p}{q}}{Q}{\Gamma_2}}$

  \vspace{2em}

  $\infrule{\begin{array}{l} \inferproof{\Gamma}{p}{\Ex{x}[A]{P}}{\Gamma_1} \\ \infertype{\assume{\extend{\Gamma}{y}{A}[\choose{p}]}{h}{\subst{P}{x}{y}}}[\noncomputable]{e}{B}{\assume{\extend{\Gamma_2}{y}{A}[\choose{p}]}{h}{\subst{P}{x}{y}}} \end{array}}{\infertype{\Gamma}[\noncomputable]{\choosewitnessp{y}{h}{p}{e}}{B}{\Gamma_2}}$
\end{center}
