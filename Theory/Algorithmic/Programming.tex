...
\begin{center}
  ...
  $\infrule{\inferkind{\Gamma}{A}[s_1]{\Gamma_1} \quad \inferkind{\Gamma_1}{B}[s_2]{\Gamma_2}}{\inferkind{\Gamma}{\Prod{A}{B}}[\supqty{s_1}{s_2}]{\Gamma_2}}$

  \vspace{1em}

  $\infrule{\inferkind{\Gamma}{A}[s_1]{\Gamma_1} \quad \inferkind{\Gamma_1}{B}[s_2]{\Gamma_2}}{\inferkind{\Gamma}{\Sum{A}{B}}[\supqty{s_1}{s_2}]{\Gamma_2}}$
\end{center}
...
\begin{center}
  ...
  $\infrule{\infertype{\Gamma}{f}{\Fun[r]{A}{B}}{\Gamma_1} \quad \divmodctx{\Gamma_1}{r} = (\Gamma_2, \Gamma_3) \quad \checktype{\Gamma_2}{a}{A}{\Gamma_4}}{\infertype{\Gamma}{\app{f}{a}}{B}{\addctx{\Gamma_3}{\scalectx{r}{\Gamma_4}}}}$
\end{center}
...
\begin{center}
  $\infrule{\divmodctx{\Gamma}{r} = (\Gamma_1, \Gamma_2) \quad \checktype{\Gamma_1}{e}{A}{\Gamma_3}}{\checktype{\Gamma}{\boxintro{e}}{\Box[r]{A}}{\addctx{\Gamma_2}{\scalectx{r}{\Gamma_3}}}}$
...
\begin{center}
    ...
    $\infrule{\begin{array}{l} \infertype{\Gamma}{e_1}{\Prod{A}{B}}{\Gamma_1} \\ \infertype{\extend{\extend{\Gamma_1}[\totalqty{\One}{A}]{x}{A}}[\totalqty{\One}{B}]{y}{B}}{e_2}{C}{\extend{\extend{\Gamma_2}[\Zero]{x}{A}}[\Zero]{y}{B}} \end{array}}{\infertype{\Gamma}{\letpair{x}{y}{e_1}{e_2}}{C}{\Gamma_2}}$
\end{center}
...
\begin{center}
  $\infrule{\divmodctx{\Gamma}{r} = (\Gamma_1, \Gamma_2) \quad \begin{array}{l} \infertype{\Gamma_1}{e_1}{A}{\Gamma_3} \\ \infertype{\extend{(\addctx{\Gamma_2}{\scalectx{r}{\Gamma_3}})}[\totalqty{r}{A}]{x}{A}}{e_2}{B}{\extend{\Gamma_4}[\Zero]{x}{A}} \end{array}}{\infertype{\Gamma}{\letin[r]{x}{e_1}{e_2}}{B}{\Gamma_4}}$
\end{center}
