...
\begin{center}
  $\infrule{\divctx{\Gamma}{r} = (\Gamma_1, \Gamma_2) \quad \begin{array}{l} \infertype{\Gamma_1}{e_1}{A}{\Gamma_3} \\ \infertype{\extend{(\addctx{\Gamma_2}{\scalectx{r}{\Gamma_3}})}[\totalqty{r}{A}]{x}{A}}{e_2}{B}{\extend{\Gamma_4}[\Zero]{x}{A}} \end{array}}{\infertype{\Gamma}{\letin[r]{x}{e_1}{e_2}}{B}{\Gamma_4}}$
\end{center}
