...
\begin{center}
  ...
  $\infrule{\infertype{\Gamma}{e}{\Sum{A}{B}}{\Gamma_1} \quad \begin{array}{l} \checktype{\Gamma_1}{f}{\Fun[\One]{A}{C}}{\Gamma_2} \\ \checktype{\Gamma_1}{g}{\Fun[\One]{B}{C}}{\Gamma_3} \end{array}}{\checktype{\Gamma}{\case{e}{f}{g}}{C}{\lubctx{\Gamma_2}{\Gamma_3}}}$

  \vspace{2em}

  $\infrule{\infertype{\Gamma}{e}{\Sum{A}{B}}{\Gamma_1} \quad \begin{array}{l} \infertype{\Gamma_1}{f}{\Fun[\One]{A}{C}}{\Gamma_2} \\ \infertype{\Gamma_1}{g}{\Fun[\One]{B}{C}}{\Gamma_3} \end{array}}{\infertype{\Gamma}{\case{e}{f}{g}}{C}{\lubctx{\Gamma_2}{\Gamma_3}}}$
\end{center}
