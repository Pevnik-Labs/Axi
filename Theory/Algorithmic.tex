...
The arithmetic order on quantities is $\Zero \subarith \One \subarith \Few \subarith \Many \subarith \Any$. The idea is to compare the quantities by how ``big'' they are.
