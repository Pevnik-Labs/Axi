...
\begin{itemize}
  \item Kinding: $\newkinding{\Gamma}{r}{A}{s}{\Gamma'}$ -- in context $\Gamma$, check if type $A$ is of kind $\Type[r]$, returning $s$ (which are capabilities $A$ is missing to be in $r$) and $\Gamma'$
...
\begin{frame}{Kinding -- boring type formers}
...
\begin{center}
  ...
  $\infrule{\newkinding{\Gamma}{\One}{A}{\One}{\Gamma_1} \quad \begin{array}{l} \infer{\scalectx{\Zero}{\Gamma_1}, \typehint{A}}{e}{A'}{\Gamma_2} \\ \matching{\Gamma_2}{\substctx{\Gamma_2}{A'}}{B}{\Gamma_3} \end{array}}{\infer{\Gamma}{\annot{e}{A}}{B}{\addctx{\Gamma_3}{\Gamma_1}}}$
\end{center}
...
\begin{center}
  $\infrule{\infer{\Gamma, \Delta, \tvar{a}[r], \typehint{A}}{e}{A'}{\Gamma', \tvar{a}[r], \Theta}}{\infer{\findhint{\Gamma}{\typehint{\ForallI{a}[r]{A}}}{\Delta}}{e}{\ForallI{a}[r]{A}}{\Gamma'}}$
...
\begin{center}
  ...
  $\infrule{\newkinding{\Gamma}{\One}{A}{\One}{\Gamma_1} \quad \infer{\Gamma_1, \Delta}{\emptyelim{e}}{B}{\Gamma_2}}{\infer{\Gamma, \arghint{A}, \Delta}{\emptyelim{e}}{B}{\Gamma_2}}$
\end{center}
...
\begin{frame}{Typing -- alternative rules}

\begin{center}
  $\infrule{\matching{\Gamma}{\Fun{\Empty}{\ForallI{a}{a}}}{C}{\Gamma'}}{\infer{\Gamma}{\emptyelim{}}{C}{\Gamma'}}$

  \vspace{2em}

  $\infrule{\matching{\Gamma}{\ForallI{a}{\ForallI{b}{\Fun{a}{\Fun{b}{\Prod{a}{b}}}}}}{C}{\Gamma'}}{\infer{\Gamma}{\funpair}{C}{\Gamma'}}$

  \vspace{2em}

  $\infrule{\matching{\Gamma}{\ForallI{a}{\ForallI{b}{\Fun{a}{\Sum{a}{b}}}}}{C}{\Gamma'}}{\infer{\Gamma}{\inl{}}{C}{\Gamma'}}$

  \vspace{2em}

  $\infrule{\matching{\Gamma}{\ForallI{a}{\ForallI{b}{\Fun{b}{\Sum{a}{b}}}}}{C}{\Gamma'}}{\infer{\Gamma}{\inr{}}{C}{\Gamma'}}$
\end{center}
