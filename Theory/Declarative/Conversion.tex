...
\begin{center}
  ...
  $\infrule{\type[\Gamma]{A}[r] \quad \termconv{e_1}{e_2}{\Empty}}{\termconv{\emptyelim{e_1}}{\emptyelim{e_2}}{A}}$
\end{center}
...
\begin{center}
  ...
  $\infrule{\termconv{\boxelim{x}{e_1}{x}}{\boxelim{x}{e_2}{x}}{A}}{\termconv{e_1}{e_2}{\Box[r]{A}}}$
