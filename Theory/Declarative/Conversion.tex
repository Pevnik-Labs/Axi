...
\begin{center}
  ...
  $\infrule{\typeconv{A_1}{A_2}[s_1] \quad \typeconv{B_1}{B_2}[s_2]}{\typeconv{\Prod{A_1}{B_1}}{\Prod{A_2}{B_2}}[\supqty{s_1}{s_2}]}$

  \vspace{1em}

  $\infrule{\typeconv{A_1}{A_2}[s_1] \quad \typeconv{B_1}{B_2}[s_2]}{\typeconv{\Sum{A_1}{B_1}}{\Sum{A_2}{B_2}}[\supqty{s_1}{s_2}]}$
\end{center}
