...
\begin{center}
  ...
  $\infrule{\type{A}[s_1] \quad \type{B}[s_2]}{\type{\Prod{A}{B}}[\supqty{s_1}{s_2}]}$ \quad
  $\infrule{\type{A}[s_1] \quad \type{B}[s_2]}{\type{\Sum{A}{B}}[\supqty{s_1}{s_2}]}$
\end{center}
...
\begin{center}
  ...
  $\typeqty{\Prod{A}{B}} = \supqty{\typeqty{A}}{\typeqty{B}}$ \\
  $\typeqty{\Sum{A}{B}} = \supqty{\typeqty{A}}{\typeqty{B}}$ \\
