...
\begin{center}
  ...
  $\infrule{\decomposectx{\Gamma}{\Gamma_1}{\Gamma_2} \quad \typing[\Gamma_1]{e}{\Sum{A}{B}} \quad \typing[\Gamma_2]{f}{\Fun[\One]{A}{C}} \quad \typing[\Gamma_2]{g}{\Fun[\One]{B}{C}}}{\typing[\Gamma]{\case{e}{f}{g}[C]}{C}}$
\end{center}
