...
Terms: \\
$e ::=$ \\
\qquad $\annot{e}{A} \pipe x \pipe \fun{x}{e} \pipe \app{e_1}{e_2} \pipe \itapp{e}{A} \pipe$ \\
...
\begin{center}
  $\infrule{\begin{array}{l} \infer{\scalectx{\Zero}{\Gamma}, \emptyhint}{e_1}{A}{\Gamma_1} \quad \infer{(\addctx{\scalectx{\Zero}{\Gamma_1}}{\Gamma}), \var[\Zero]{x}{A}}{e_2}{B}{\Gamma_2, \var[r]{x}{A}} \\ \newkinding{\Gamma_2}{r}{A}{s}{\Gamma_3} \end{array}}{\infer{\Gamma}{\letin{x}{e_1}{e_2}}{B}{\addctx{\Gamma_3}{\scalectx{s}{\Gamma_1}}}}$
\end{center}
