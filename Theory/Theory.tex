...
\begin{center}
  $\infrule{\begin{array}{l} \newkinding{\Gamma}{\Any}{A}{r}{\Gamma_1} \\ \infer{\scalectx{\Zero}{\Gamma_1}, \typehint{A}}{e'}{\_}{\Gamma_2} \\ \infer{\scalectx{\Zero}{\Gamma_2}, \Delta, \var[\Zero]{x}{A}}{e}{B}{\Gamma_3, \var[s]{x}{A}, \Theta} \\ \subusage{\divqty{\Any}{r}}{s} \end{array}}{\infer{\Gamma, \arghint{e'}, \Delta}{\fun{x}[A]{e}}{B}{\addctx{\Gamma_3}{\addctx{\scalectx{\divqty{s}{(\divqty{\Any}{r})}}{\Gamma_2}}{\Gamma_1}}}}$

  \vspace{2em}

  $\infrule{\begin{array}{l} \newkinding{\Gamma}{\Any}{A}{r}{\Gamma_1} \\ \infer{\Gamma_1, \Delta, \var[\Zero]{x}{A}, \emptyhint}{e}{B}{\Gamma_2, \var[s]{x}{A}, \Theta} \\ \subusage{\divqty{\Any}{r}}{s} \end{array}}{\infer{\Gamma, \emptyhint, \Delta}{\fun{x}[A]{e}}{\Fun{A}{B}}{\Gamma_2}}$
\end{center}
...
\begin{center}
  ...
  $\infrule{\newkinding{\Gamma}{\Any}{B}{r}{\Gamma_1} \quad \infer{\Gamma_1, \Delta, \tvar{a}[\divqty{\Any}{r}]}{e}{A}{\Gamma_2}}{\infer{\Gamma, \explicithint{B}, \Delta}{\tfun{a}{e}}{\ForallE{a}{\divqty{\Any}{r}}{A}}{\Gamma_2}}$
\end{center}
...
\begin{center}
  $\infrule{\begin{array}{l} \infer{\scalectx{\Zero}{\Gamma}, \emptyhint}{e}{\Sum{A}{B}}{\Gamma_1} \\ \infer{\scalectx{\Zero}{\Gamma_1}, \var[\Zero]{x}{A}}{e_1}{C_1}{\Gamma_2, \var[r_A]{x}{A}} \\ \infer{\scalectx{\Zero}{\Gamma_1}, \var[\Zero]{y}{B}}{e_2}{C_2}{\Gamma_3, \var[r_B]{y}{B}} \\ \Gamma_4 = \glbctx{\Gamma_2}{\Gamma_3} \\ \subtyping{\Gamma_4}{\One}{C_1}{C_2}{\One}{\Gamma_5} \\ \subtyping{\Gamma_5}{\One}{C_2}{C_1}{\One}{\Gamma_6} \\ \newkinding{\Gamma_6}{r_A}{A}{s_A}{\Gamma_7} \\ \newkinding{\Gamma_7}{r_B}{B}{s_B}{\Gamma_8} \end{array}}{\infer{\Gamma}{\newcase{e}{x}{e_1}{y}{e_2}}{C_1}{\addctx{\Gamma_8}{\addctx{\scalectx{(\glbqty{s_A}{s_B})}{\Gamma_1}}{\Gamma}}}}$
\end{center}
