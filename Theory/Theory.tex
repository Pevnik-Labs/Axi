...
\begin{frame}{Typing -- function abstraction}
...
\begin{frame}{Typing -- smarter hint rule for functions}

\begin{center}
  $\infrule{\begin{array}{l} \infer{\scalectx{\Zero}{\Gamma}, \emptyhint}{e'}{A}{\Gamma_1} \\ \infer{(\addctx{\scalectx{\Zero}{\Gamma_1}}{\Gamma}), \Delta, \var[\Zero]{x}{A}}{e}{B}{\Gamma_2, \var[r]{x}{A}, \Theta} \\ \newkinding{\Gamma_2}{r}{\substctx{\Gamma_2}{A}}{s}{\Gamma_3} \end{array}}{\infer{\Gamma, \arghint{e'}, \Delta}{\fun{x}{e}}{B}{\addctx{\Gamma_3}{\scalectx{s}{\Gamma_1}}}}$
\end{center}

\vspace{2em}

Note: this rule is equivalent to the rule for let expressions which automatically takes care of boxing.

\end{frame}

\begin{frame}{Typing -- functions with annotation}

\begin{center}
  $\infrule{\begin{array}{l} \infer{\Gamma, \typehint{A}}{e'}{\_}{\Gamma_1} \\ \infer{\Gamma_1, \Delta, \var[\Zero]{x}{A}}{e}{B}{\Gamma_2, \var[r]{x}{A}, \Theta} \\ \newkinding{\Gamma_2}{r}{\substctx{\Gamma_2}{A}}{\One}{\Gamma_3} \end{array}}{\infer{\Gamma, \arghint{e'}, \Delta}{\fun{x}[A]{e}}{B}{\Gamma_3}}$

  \vspace{2em}

  $\infrule{\begin{array}{l} \infer{\Gamma, \Delta, \var[\Zero]{x}{A}, \emptyhint}{e}{B}{\Gamma_1, \var[r]{x}{A}, \Theta} \\ \newkinding{\Gamma_1}{r}{A}{\One}{\Gamma_2} \end{array}}{\infer{\Gamma, \emptyhint, \Delta}{\fun{x}[A]{e}}{\Fun{A}{B}}{\Gamma_2}}$
\end{center}
...
\begin{center}
  $\infrule{\begin{array}{l} \infer{\scalectx{\Zero}{\Gamma}, \emptyhint}{e_1}{A}{\Gamma_1} \\ \infer{(\addctx{\scalectx{\Zero}{\Gamma_1}}{\Gamma}), \var[\Zero]{x}{A}}{e_2}{B}{\Gamma_2, \var[r]{x}{A}} \\ \newkinding{\Gamma_2}{r}{A}{s}{\Gamma_3} \end{array}}{\infer{\Gamma}{\letin{x}{e_1}{e_2}}{B}{\addctx{\Gamma_3}{\scalectx{s}{\Gamma_1}}}}$

  \vspace{2em}

  $\infrule{\begin{array}{l} \infer{\scalectx{\Zero}{\Gamma}, \typehint{A}}{e_1}{\_}{\Gamma_1} \\ \infer{(\addctx{\scalectx{\Zero}{\Gamma_1}}{\Gamma}), \var[\Zero]{x}{A}}{e_2}{B}{\Gamma_2, \var[r]{x}{A}} \\ \newkinding{\Gamma_2}{r}{A}{s}{\Gamma_3} \end{array}}{\infer{\Gamma}{\letin{x}[A]{e_1}{e_2}}{B}{\addctx{\Gamma_3}{\scalectx{s}{\Gamma_1}}}}$
\end{center}
