...
\begin{center}
  ...
  $\infrule{\termorder{e_1}{e_2}}{\termorder{\elimEmpty{e_1}}{\elimEmpty{e_2}}}$
\end{center}
...
\begin{itemize}
  ...
  \item $\iexfalso{A}{e} :\equiv \annot{\elimEmpty{e}}{A}$
\end{itemize}
...
Rules for lambdas and sum constructors can be derived by first using the rule for annotations and then the corresponding hint-based rule. For $\elimEmpty{}$ we also need to use the squeeze theorem on the premise.
