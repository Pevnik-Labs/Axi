...
\begin{center}
  $\infrule[True-Intro]{}{\proofinfer{\true}{\True}}$

  \vspace{2em}

  $\infrule[False-Elim]{\proofcheck{e}{\False}}{\proofcheck{\exfalso{e}}{P}}$
\end{center}
...
\begin{center}
  ...
  $\infrule[Impl-Intro-Infer]{\prop{\Gamma}{P} \quad \fullproofinfer{\assume{\Gamma}{P}}{e}{Q}}{\proofinfer{\implintro{P}{e}}{\Impl{P}{Q}}}$
...
\begin{center}
  $\infrule[Not-Intro]{\prop{\Gamma}{P} \quad \fullproofcheck{\assume{\Gamma}{P}}{e}{\False}}{\proofinfer{\notintro{P}{e}}{\Not{P}}}$
...
\newcommand{\allintroannot}[3]{\allintro{#1 : #2}{#3}}
...
\begin{center}
  ...
  $\infrule[Forall-Intro-Infer]{\fullproofinfer{\extend{\Gamma}{x}{A}}{e}{P}}{\proofinfer{\allintroannot{x}{A}{e}}{\All{x}{A}{P}}}$
...
\begin{center}
  ...
  $\infrule[Exists-Elim]{\proofinfer{e_1}{\Ex{x}{A}{P}} \quad \fullproofinfer{\assume{\extend{\Gamma}{y}{A}}{\subst{P}{x}{y}}}{e_2}{R}}{\proofinfer{\exelim{y}{e_1}{e_2}}{R}}$

  \vspace{2em}

  $\infrule[Exists-Elim-Check]{\proofinfer{e_1}{\Ex{x}{A}{P}} \quad \fullproofcheck{\assume{\extend{\Gamma}{y}{A}}{\subst{P}{x}{y}}}{e_2}{R}}{\proofcheck{\exelim{y}{e_1}{e_2}}{R}}$
\end{center}
...
\newcommand{\reflnaked}{\mathbf{refl}}

\begin{frame}{Experimenting with $\reflnaked$}

\begin{center}
  $\infrule[Eq-Intro-Alt]{\checkcompeq{t_1}{t_2}{A}}{\proofcheck{\reflnaked}{\Eq[A]{t_1}{t_2}}}$
\end{center}
