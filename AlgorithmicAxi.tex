...
\begin{center}
  $\infrule[True-Intro]{\tyctx{\Gamma}}{\proofcheck{\true}{\True}}$
...
\begin{center}
  $\infrule[Impl-Intro]{\fullproofcheck{\assume{\Gamma}{P}}{e}{Q}}{\proofcheck{\implintro{P}{e}}{\Impl{P}{Q}}}$
...
\begin{center}
  $\infrule[Not-Intro]{\fullproofcheck{\assume{\Gamma}{P}}{e}{\False}}{\proofcheck{\notintro{P}{e}}{\Not{P}}}$
...
\begin{center}
  ...
  $\infrule[Or-Elim]{\proofinfer{e_1}{\Or{P}{Q}} \quad \proofcheck{e_2}{\Impl{P}{R}} \quad \proofcheck{e_3}{\Impl{Q}{R}}}{\proofinfer{\orelim{e_1}{e_2}{e_3}}{R}}$
\end{center}
...
\begin{center}
  $\infrule[Classic]{\proofinfer{e}{\Not{\Not{P}}}}{\proofinfer{\dn{e}}{P}}$
\end{center}
...
\begin{center}
  $\infrule{\prop{\extend{\Gamma}{x}{\Sum{A}{B}}}{P} \quad \infer{t}{\Sum{A}{B}} \quad \begin{array}{c} \fullproofinfer{\extend{\Gamma}{a}{A}}{e_1}{\subst{P}{x}{\inl{a}}} \\ \fullproofinfer{\extend{\Gamma}{b}{B}}{e_2}{\subst{P}{x}{\inr{b}}} \end{array}}{\proofinfer{\sumind{t}{a}{e_1}{b}{e_2}}{\subst{P}{x}{t}}}$
\end{center}
