...
\begin{center}
  ...
  $\infrule{\checkcompeq{e_1}{e_2}{\Empty}}{\checkcompeq{\elimEmpty{e_1}}{\elimEmpty{e_2}}{A}}$
\end{center}
...
\begin{center}
  $\infrule[Fun-Uniq-Alt]{\fullcheckcompeq{\extend{\Gamma}{x}{A}}{\app{f}{x}}{\app{g}{x}}{B}}{\checkcompeq{f}{g}{\Fun{A}{B}}}$
...
\begin{center}
  $\infrule[Proof-Annot]{\proofcheck{e}{P}}{\proofinfer{\proofannot{P}{e}}{P}}$
\end{center}
...
\begin{center}
  $\infrule[Ass]{\tyctx{\Gamma} \quad \sidecond{P \in \Gamma}}{\proofinfer{P}{P}}$
\end{center}
...
\begin{center}
  $\infrule[True-Intro]{\tyctx{\Gamma}}{\proofinfer{\true}{\True}}$

  \vspace{2em}

  $\infrule[False-Elim]{\prop{\Gamma}{P} \quad \proofcheck{e}{\False}}{\proofcheck{\exfalso{e}}{P}}$
\end{center}
...
\begin{center}
  $\infrule[Impl-Intro-Check]{\fullproofcheck{\assume{\Gamma}{P}}{e}{Q}}{\proofcheck{\implintro{P}{e}}{\Impl{P}{Q}}}$

  \vspace{2em}

  $\infrule[Impl-Intro-Infer]{\fullproofinfer{\assume{\Gamma}{P}}{e}{Q}}{\proofinfer{\implintro{P}{e}}{\Impl{P}{Q}}}$
...
\begin{center}
  $\infrule[Not-Intro]{\fullproofcheck{\assume{\Gamma}{P}}{e}{\False}}{\proofinfer{\notintro{P}{e}}{\Not{P}}}$
...
\begin{center}
  $\infrule[Or-Intro-L]{\prop{\Gamma}{Q} \quad \proofcheck{e}{P}}{\proofcheck{\orintrol{Q}{e}}{\Or{P}{Q}}}$

  \vspace{2em}

  $\infrule[Or-Intro-R]{\prop{\Gamma}{P} \quad \proofcheck{e}{Q}}{\proofcheck{\orintror{P}{e}}{\Or{P}{Q}}}$
...
\begin{center}
  $\infrule[Cut]{\proofinfer{e_1}{P} \quad \fullproofcheck{\assume{\Gamma}{P}}{e_2}{Q}}{\proofcheck{\cut{e_1}{e_2}}{Q}}$

  \vspace{2em}

  $\infrule[Cut-Infer]{\proofinfer{e_1}{P} \quad \fullproofinfer{\assume{\Gamma}{P}}{e_2}{Q}}{\proofinfer{\cut{e_1}{e_2}}{Q}}$
\end{center}
...
\begin{center}
  $\infrule[Forall-Intro]{\fullproofcheck{\extend{\Gamma}{y}{A}}{e}{\subst{P}{x}{y}}}{\proofcheck{\allintro{y}{e}}{\All{x}{A}{P}}}$

  \vspace{2em}

  $\infrule[Forall-Intro-Infer]{\fullproofinfer{\extend{\Gamma}{x}{A}}{e}{P}}{\proofinfer{\allintro{x : A}{e}}{\All{x}{A}{P}}}$
...
\begin{center}
  ...
  $\infrule[Exists-Elim]{\prop{\Gamma}{R} \quad \proofinfer{e_1}{\Ex{x}{A}{P}} \quad \fullproofinfer{\assume{\extend{\Gamma}{y}{A}}{\subst{P}{x}{y}}}{e_2}{R}}{\proofinfer{\exelim{y}{e_1}{e_2}}{R}}$

  \vspace{2em}

  $\infrule[Exists-Elim-Check]{\prop{\Gamma}{R} \quad \proofinfer{e_1}{\Ex{x}{A}{P}} \quad \fullproofcheck{\assume{\extend{\Gamma}{y}{A}}{\subst{P}{x}{y}}}{e_2}{R}}{\proofcheck{\exelim{y}{e_1}{e_2}}{R}}$
\end{center}
...
\begin{center}
  $\infrule{\prop{\extend{\Gamma}{x}{\Sum{A}{B}}}{P} \quad \infer{t}{\Sum{A}{B}} \quad \begin{array}{c} \fullproofcheck{\extend{\Gamma}{a}{A}}{e_1}{\subst{P}{x}{\inl{a}}} \\ \fullproofcheck{\extend{\Gamma}{b}{B}}{e_2}{\subst{P}{x}{\inr{b}}} \end{array}}{\proofinfer{\sumind{t}{a}{e_1}{b}{e_2}}{\subst{P}{x}{t}}}$
\end{center}
