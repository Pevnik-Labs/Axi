...
\begin{center}
  $\infrule{\prop[\extend{\Gamma}{x}{\Sum{A}{B}}]{P} \quad \infer{t}{\Sum{A}{B}} \quad \begin{array}{c} \proofcheck[\extend{\Gamma}{a}{A}]{e_1}{\subst{P}{x}{\inl{a}}} \\ \proofcheck[\extend{\Gamma}{b}{B}]{e_2}{\subst{P}{x}{\inr{b}}} \end{array}}{\proofinfer{\sumind{t}{a}{e_1}{b}{e_2}}{\subst{P}{x}{t}}}$
\end{center}
