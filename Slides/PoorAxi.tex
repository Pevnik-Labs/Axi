...
\begin{center}
  $\infrule[App-Lam-Def]{\compeq[\extenddef{\Gamma}{x}{A}{a}]{b}{b'}{B}}{\compeq{\app{(\fun{x}{b})}{a}}{b'}{B}}$

  \vspace{1em}

  $\infrule[Let-Comp-Def]{\compeq[\extenddef{\Gamma}{x}{A}{e_1}]{e_2}{e_2'}{B}}{\compeq{\letin{x}{e_1}{e_2}}{e_2'}{B}}$
\end{center}
