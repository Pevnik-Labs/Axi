...
Q: Do we want to disallow shadowing? \\
Q: Do we really need to check type/proposition well-formedness in a cartesianized context?
...
Q: Do we want first-order representation of the branches?
