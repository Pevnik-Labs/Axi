...
\begin{center}
  ...
  $\infrule{\subctx{\Gamma}{\addctx{\Gamma_1}{\Gamma_2}} \quad \fulltyping{\Gamma_1}{e_1}{\Box[r]{A}} \quad \fulltyping{\extend{\Gamma_2}[\totalqty{r}{A}]{x}{A}}{e_2}{B}}{\fulltyping{\Gamma}{\boxelim{x}[A]{e_1}{e_2}}{B}}$
\end{center}
