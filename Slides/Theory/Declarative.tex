...
\begin{frame}{Division with remainder (TODO)}

$\divqty{a}{b}$ is some good $(q, r)$ such that $\subusage{a}{\addqty{\mulqty{b}{q}}{r}}$.
...
\begin{table}[ht]
  ...
  $\Few$              & $\Any$          & $\Few$  & $\Few$          & $\Zero$         & $\Zero$         \\ \hline
  $\Many$             & $(\Any, \Many)$ & $\Many$ & $(\Any, \Many)$ & $\Many$         & $(\Any, \Many)$ \\ \hline
  $\Any$              & $\Any$          & $\Any$  & $\Any$          & $\Any$          & $\Any$          \\ \hline
  \end{tabular}
\end{table}
