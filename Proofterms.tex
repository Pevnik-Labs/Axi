...
Because we no longer have separate assumption contexts, but still need to keep track of well-formedness of assumptions, we drop the valid assumption context judgement $\assctx{\Gamma}{\Delta}$ and replace it with the valid context judgement $\tyctx{\Gamma}$, which should be read: $\Gamma$ is a well-formed context.
...
\begin{itemize}
  \item $\tyctx{\Gamma}$ entails nothing (because it is the simplest judgement)
  \item $\prop{\Gamma}{P}$ entails $\tyctx{\Gamma}$
  \item $\proves{e}{P}$ entails $\prop{\Gamma}{P}$
\end{itemize}
...
\begin{itemize}
  \item $\typing{e}{A}$ entails $\tyctx{\Gamma}$
  \item $\computation{e_1}{e_2}{A}$ entails $\typing{e_1}{A}$ and $\typing{e_2}{A}$
\end{itemize}
...
\begin{center}
  $\infrule[Ass]{\tyctx{\Gamma} \quad \sidecond{P \in \Gamma}}{\proves{P}{P}}$
\end{center}
...
\begin{center}
  $\infrule[True-Intro]{\tyctx{\Gamma}}{\proves{\true}{\True}}$
...
$\true$ proves the true proposition $\True$ in any well-formed context.

\vspace{1em}

$\exfalso{e}$ proves any well-formed proposition $P$ whatsoever, provided that $e$ proves the false proposition $\False$.
...
\begin{center}
  $\infrule[Impl-Intro]{\fullproves{\assume{\Gamma}{P}}{e}{Q}}{\proves{\implintro{P}{e}}{\Impl{P}{Q}}}$
...
\begin{center}
  $\infrule[Not-Intro]{\fullproves{\assume{\Gamma}{P}}{e}{\False}}{\proves{\notintro{P}{e}}{\Not{P}}}$
...
\begin{center}
  $\infrule[Or-Elim-Alt]{\proves{e_1}{\Or{P}{Q}} \quad \fullproves{\assume{\Gamma}{P}}{e_2}{R} \quad \fullproves{\assume{\Gamma}{Q}}{e_3}{R}}{\proves{\orelim{e_1}{e_2}{e_3}}{R}}$
\end{center}
...
\begin{center}
  $\infrule[By-Contradiction]{\fullproves{\assume{\Gamma}{\Not{P}}}{e}{\False}}{\proves{\bycontradiction{e}}{P}}$
\end{center}

\vspace{2em}

$\bycontradiction{e}$ proves $P$ provided that $e$ proves $\False$ in the context extended with the assumption $\Not{P}$.
...
\begin{center}
  $\infrule[Cut]{\proves{e_1}{P} \quad \fullproves{\assume{\Gamma}{P}}{e_2}{Q}}{\proves{\cut{e_1}{e_2}}{Q}}$
\end{center}
...
\begin{center}
  $\infrule[Forall-Intro]{\fullproves{\extend{\Gamma}{y}{A}}{e}{\subst{P}{x}{y}}}{\proves{\allintro{y}{e}}{\All{x}{A}{P}}}$
...
\begin{center}
  ...
  $\infrule[Exists-Elim]{\prop{\Gamma}{R} \quad \proves{e_1}{\Ex{x}{A}{P}} \quad \fullproves{\assume{\extend{\Gamma}{y}{A}}{\subst{P}{x}{y}}}{e_2}{R}}{\proves{\exelim{y}{e_1}{e_2}}{R}}$
\end{center}
...
\begin{center}
  $\infrule[Funext-Alt]{\fullproves{\extend{\Gamma}{x}{A}}{e}{\Eq[B]{\app{f}{x}}{\app{g}{x}}}}{\proves{\funextalt{x}{e}}{\Eq[\Fun{A}{B}]{f}{g}}}$
\end{center}
...
\begin{center}
  $\infrule{\prop{\extend{\Gamma}{x}{\Sum{A}{B}}}{P} \quad \typing{t}{\Sum{A}{B}} \quad \begin{array}{c} \fullproves{\extend{\Gamma}{a}{A}}{e_1}{\subst{P}{x}{\inl{a}}} \\ \fullproves{\extend{\Gamma}{b}{B}}{e_2}{\subst{P}{x}{\inr{b}}} \end{array}}{\proves{\sumind{t}{a}{e_1}{b}{e_2}}{\subst{P}{x}{t}}}$
\end{center}
