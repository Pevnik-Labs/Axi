...
\begin{center}
  ...
  $\infrule[False-Elim]{\prop{\Gamma}{P} \quad \proves{e}{\False}}{\proves{\exfalso{e}}{P}}$
\end{center}
...
\begin{center}
  $\infrule[Or-Intro-L]{\prop{\Gamma}{Q} \quad \proves{e}{P}}{\proves{\orintrol{Q}{e}}{\Or{P}{Q}}}$

  \vspace{2em}

  $\infrule[Or-Intro-R]{\prop{\Gamma}{P} \quad \proves{e}{Q}}{\proves{\orintror{P}{e}}{\Or{P}{Q}}}$
