...
\begin{center}
  $\infrule[\rulename{Ctx-Empty}]{}{\tyctx{\emptytypingctx}}$ \quad
  $\infrule[\rulename{Ctx-Extend}]{\tyctx{\Gamma} \quad \sidecond{x \notin \Gamma}}{\tyctx{\extend{\Gamma}{x}{A}}}$
\end{center}
...
\begin{center}
  $\infrule[\rulename{Var}]{\tyctx{\Gamma} \quad \sidecond{(x : A) \in \Gamma}}{\typing{\Gamma}{x}{A}}$
\end{center}
...
\begin{center}
  $\infrule{\typing{\extend{\Gamma}{x}{A}}{e}{B}}{\typing{\Gamma}{\fun{x}{e}}{\Fun{A}{B}}}$ \quad
  ...
  $\infrule{\typing{\Gamma}{e}{\Sum{A}{B}} \quad \typing{\Gamma}{f}{\Fun{A}{C}} \quad \typing{\Gamma}{g}{\Fun{B}{C}}}{\typing{\Gamma}{\case{e}{f}{g}}{C}}$

  \vspace{2em}

  $\infrule{\tyctx{\Gamma}}{\typing{\Gamma}{\unit}{\Unit}}$ \quad
...
\begin{center}
  $\infrule{\typing{\extend{\Gamma}{x}{A}}{b}{B} \quad \typing{\Gamma}{a}{A}}{\computation{\Gamma}{\app{(\fun{x}{b})}{a}}{\subst{b}{x}{a}}{B}}$
  ...
  $\infrule{\typing{\Gamma}{a}{A} \quad \typing{\Gamma}{f}{\Fun{A}{C}} \quad \typing{\Gamma}{g}{\Fun{B}{C}}}{\computation{\Gamma}{\case{(\inl[a])}{f}{g}}{\app{f}{a}}{C}}$

  \vspace{1em}

  $\infrule{\typing{\Gamma}{a}{A} \quad \typing{\Gamma}{f}{\Fun{A}{C}} \quad \typing{\Gamma}{g}{\Fun{B}{C}}}{\computation{\Gamma}{\case{(\inr[b])}{f}{g}}{\app{g}{b}}{C}}$
\end{center}
...
\begin{center}
  $\infrule[\rulename{CompEq-Refl}]{\typing{\Gamma}{e}{A}}{\computation{\Gamma}{e}{e}{A}}$

  \vspace{2em}

  $\infrule[\rulename{CompEq-Sym}]{\computation{\Gamma}{e_1}{e_2}{A}}{\computation{\Gamma}{e_2}{e_1}{A}}$

  \vspace{2em}

  $\infrule[\rulename{CompEq-Trans}]{\computation{\Gamma}{e_1}{e_2}{A} \quad \computation{\Gamma}{e_2}{e_3}{A}}{\computation{\Gamma}{e_1}{e_3}{A}}$
\end{center}
...
\begin{center}
  $\infrule{\computation{\extend{\Gamma}{x}{A}}{e}{e'}{B}}{\computation{\Gamma}{\fun{x}{e}}{\fun{x}{e'}}{\Fun{A}{B}}}$ \quad
  ...
  $\infrule{\computation{\Gamma}{e}{e'}{\Sum{A}{B}} \quad \computation{\Gamma}{f}{f'}{\Fun{A}{C}} \quad \computation{\Gamma}{g}{g'}{\Fun{B}{C}}}{\computation{\Gamma}{\case{e}{f}{g}}{\case{e'}{f'}{g'}}{C}}$

  \vspace{1em}

  $\infrule{\tyctx{\Gamma}}{\computation{\Gamma}{\unit}{\unit}{\Unit}}$ \quad
...
\begin{center}
  $\infrule{\tyctx{\Gamma}}{\assctx{\Gamma}{\emptyassctx}}$ \quad
  $\infrule{\assctx{\Gamma}{\Delta} \quad \prop{\Gamma}{P}}{\assctx{\Gamma}{\assume{\Delta}{P}}}$
\end{center}
...
\begin{center}
  $\infrule{\assctx{\Gamma}{\Delta} \quad \sidecond{P \in \Delta}}{\holds{\Gamma}{\Delta}{P}}$
\end{center}
...
\begin{center}
  $\infrule{\holds{\Gamma}{\assume{\Delta}{P}}{Q}}{\holds{\Gamma}{\Delta}{\Impl{P}{Q}}}$ \quad
  ...
  $\infrule{\holds{\Gamma}{\Delta}{\Or{P}{Q}} \quad \holds{\Gamma}{\assume{\Delta}{P}}{R} \quad \holds{\Gamma}{\assume{\Delta}{Q}}{R}}{\holds{\Gamma}{\Delta}{R}}$

  \vspace{1em}

  $\infrule{\assctx{\Gamma}{\Delta}}{\holds{\Gamma}{\Delta}{\True}}$ \quad
...
\begin{center}
  $\infrule{\holds{\extend{\Gamma}{x}{A}}{\Delta}{P}}{\holds{\Gamma}{\Delta}{\All{x}{A}{P}}}$ \qquad
  ...
  $\infrule{\holds{\Gamma}{\Delta}{\Ex{x}{A}{P}} \quad \holds{\extend{\Gamma}{x}{A}}{\assume{\Delta}{P}}{R}}{\holds{\Gamma}{\Delta}{R}}$
\end{center}
...
\begin{center}
  $\infrule{\assctx{\Gamma}{\Delta} \quad \computation{\Gamma}{e_1}{e_2}{A}}{\holds{\Gamma}{\Delta}{\Eq[A]{e_1}{e_2}}}$
  ...
  $\infrule{\holds{\Gamma}{\Delta}{\Eq[A]{e_1}{e_2}} \quad \prop{\extend{\Gamma}{x}{A}}{P} \quad \holds{\Gamma}{\Delta}{\subst{P}{x}{e_2}}}{\holds{\Gamma}{\Delta}{\subst{P}{x}{e_1}}}$
\end{center}
...
\begin{center}
  $\infrule{\assctx{\Gamma}{\Delta} \quad \typing{\Gamma}{e}{\Empty}}{\holds{\Gamma}{\Delta}{P}}$

  \vspace{1em}

  $\infrule{\holds{\extend{\Gamma}{a}{A}}{\Delta}{\subst{P}{x}{\inl[a]}} \quad \holds{\extend{\Gamma}{b}{B}}{\Delta}{\subst{P}{x}{\inr[b]}}}{\holds{\Gamma}{\Delta}{\All{x}{\Sum{A}{B}}{P}}}$
\end{center}
...
\begin{center}
  $\infrule{\prop{\Gamma}{P} \quad \holds{\Gamma}{\assume{\Delta}{P}}{R} \quad \holds{\Gamma}{\assume{\Delta}{\Not{P}}}{R}}{\holds{\Gamma}{\Delta}{R}}$
\end{center}
...
\begin{center}
  $\infrule{\tyctx{\Gamma}}{\typing{\Gamma}{\true}{\Bool}}$ \quad
  $\infrule{\tyctx{\Gamma}}{\typing{\Gamma}{\false}{\Bool}}$
...
\begin{center}
  $\infrule{\tyctx{\Gamma}}{\typing{\Gamma}{\zero}{\Nat}}$ \quad
  ...
  $\infrule{\holds{\Gamma}{\Delta}{\subst{P}{n}{\zero}} \quad \holds{\extend{\Gamma}{n'}{\Nat}}{\assume{\Delta}{\subst{P}{n}{n'}}}{\subst{P}{n}{\succ[n']}}}{\holds{\Gamma}{\Delta}{\All{n}{\Nat}{P}}}$
\end{center}
...
\begin{center}
  $\infrule{\tyctx{\Gamma}}{\typing{\Gamma}{\nil}{\List{A}}}$ \quad
  ...
  $\infrule{\holds{\Gamma}{\Delta}{\subst{P}{l}{\nil}} \quad \holds{\extend{\extend{\Gamma}{h}{A}}{t}{\List{A}}}{\assume{\Delta}{\subst{P}{l}{t}}}{\subst{P}{l}{\cons{h}{t}}}}{\holds{\Gamma}{\Delta}{\All{l}{\List{A}}{P}}}$
\end{center}
...
\begin{center}
  ...
  %$\infrule{\holds{\Gamma}{\assume{\Delta}{R}}{\Eq[A]{\hd{s_1}}{\hd{s_2}}} \quad \holds{\Gamma}{\assume{\Delta}{R}}{\subst{\subst{R}{x}{\tl[s_1]}}{y}{\tl[s_2]}}}{\holds{\Gamma}{\Delta}{\Eq[\AxiStream{A}]{s_1}{s_2}}}$
\end{center}
...
\begin{center}
  $\infrule{\tyctx{\Gamma} \quad \typing{\Gamma}{e}{A} \quad \sidecond{x \notin \Gamma}}{\tyctx{\extenddef{\Gamma}{x}{A}{e}}}$

  \vspace{1em}

  $\infrule{\tyctx{\extenddef{\Gamma}{x}{A}{e}}}{\computation{\extenddef{\Gamma}{x}{A}{e}}{x}{e}{A}}$
\end{center}
...
\begin{center}
  $\infrule{\typing{\Gamma}{e_1}{A} \quad \typing{\extend{\Gamma}{x}{A}}{e_2}{B}}{\typing{\Gamma}{\letin{x}{e_1}{e_2}}{B}}$
  ...
  $\infrule{\computation{\Gamma}{e_1}{e_1'}{A} \quad \computation{\Gamma}{e_2}{e_2'}{B}}{\computation{\Gamma}{\letin{x}{e_1}{e_2}}{\letin{x}{e_1'}{e_2'}}{B}}$
\end{center}

If definitions from the previous slide are available, we might modify the computation rule to make use of it.

\begin{center}
  $\infrule{\computation{\extenddef{\Gamma}{x}{A}{e_1}}{e_2}{e_2'}{B}}{\computation{\Gamma}{\letin{x}{e_1}{e_2}}{e_2'}{B}}$
\end{center}
...
\begin{center}
  $\infrule{\forall i. \quad \typing{\Gamma}{e_i}{A_i}}{\typing{\Gamma}{\record{\fields{\ell}{e}{i}}}{\recordtype{\ctype{\ell_i}{A_i}}}}$

  \vspace{1em}

  $\infrule{\typing{\Gamma}{e}{R} \quad \sidecond{(\ctype{\ell}{A}) \in R}}{\typing{\Gamma}{\proj{\ell}{e}}{A}}$

  \vspace{1em}

  $\infrule{\typing{\Gamma}{\record{\fields{\ell}{e}{i}}}{\recordtype{\ctype{\ell_i}{A_i}}} \quad \sidecond{\exists i. \ell = \ell_i}}{\computation{\Gamma}{\proj{l}{\record{\fields{\ell}{e}{i}}}}{e_i}{A_i}}$

  \vspace{1em}

  $\infrule{\typing{\Gamma}{r}{\recordtype{\ctype{\ell_i}{A_i}}}}{\computation{\Gamma}{r}{\record{\field{\ell_i}{\proj{\ell_i}{r}}}}{\recordtype{\ctype{\ell_i}{A_i}}}}$
\end{center}
...
\begin{center}
  $\infrule{\tyctx{\Gamma} \quad \validtype{\Gamma}{A} \quad \sidecond{x \notin \Gamma}}{\tyctx{\extend{\Gamma}{x}{A}}}$
\end{center}
...
\begin{center}
  $\infrule{\Gamma \vdash A\ \texttt{type} \quad \prop{\extend{\Gamma}{x}{A}}{P}}{\Gamma \vdash \refinement{x}{A}{P}\ \texttt{type}}$

  \vspace{1em}

  $\infrule{\typing{\Gamma \pipe \Delta}{e}{A} \quad \holds{\Gamma}{\Delta}{P}}{\typing{\Gamma \pipe \Delta}{\texttt{intro}\ e}{\refinement{x}{A}{P}}}$

  \vspace{1em}

  $\infrule{\typing{\Gamma \pipe \Delta}{e}{\refinement{x}{A}{P}}}{\typing{\Gamma \pipe \Delta}{\texttt{proj}\ e}{A}}$

  \vspace{1em}

  $\infrule{\typing{\Gamma \pipe \Delta}{e}{\refinement{x}{A}{P}}}{\holds{\Gamma}{\Delta}{\subst{P}{x}{\texttt{proj}\ e}}}$

  \vspace{1em}

  $\infrule{\typing{\Gamma \pipe \Delta}{e}{\refinement{x}{A}{P}}}{\computation{\Gamma}{\texttt{proj}\ (\texttt{intro}\ e)}{e}{A}}$
\end{center}
...
\begin{frame}{Additional features -- more, part 1}

\begin{itemize}
  \item Variant types -- this is a feature dual to records. They are basically a first-class version of non-recursive algebraic data types.
  \item Quotient types -- it is a language extension similar to refinement types, but they resemble set-theoretic quotients rather than subsets. They correspond to Athena's structures. They are absent from most varieties of type theory, but I'm not sure whether they won't be possible here.
...
\begin{frame}{Additional features -- more, part 2}
...
\begin{itemize}
  \item The system could be presented using a reduction which would cover the ``directed'' part of computational equality.
