...
Some of the less obvious terms: $\outl{e}$ and $\outr{e}$ are projections, $unit$ is the only value of the $Unit$ type and $\emptyelim{e}$ is the eliminator of the empty type applied to $e$. $\case{e}{e_1}{e_2}$ is the eliminator of the sum type and its arguments $e_1, e_2$ are supposed to be functions. Note that we don't have a type annotation on the lambda, and no type annotations in the language in general. This is not an oversight -- we postpone deciding this detail for later.
...
\begin{center}
  $\infrule[App-Lam]{\fulltyping{\extend{\Gamma}{x}{A}}{b}{B} \quad \typing{a}{A}}{\compeq{\app{(\fun{x}{b})}{a}}{\subst{b}{x}{a}}{B}}$
...
\begin{center}
  $\infrule{\fullcompeq{\extend{\Gamma}{x}{A}}{e}{e'}{B}}{\compeq{\fun{x}{e}}{\fun{x}{e'}}{\Fun{A}{B}}}$ \quad
...
\begin{center}
  $\infrule[Eq-Refl]{\assctx{\Gamma}{\Delta} \quad \compeq{e_1}{e_2}{A}}{\holds{\Eq[A]{e_1}{e_2}}}$
...
\begin{center}
  ...
  %$\infrule{}{\compeq{\btrue}{\btrue}{\Bool}}$ \quad
  %$\infrule{}{\compeq{\bfalse}{\bfalse}{\Bool}}$ \quad

  %\vspace{1em}

  %$\infrule{\compeq{e}{e'}{\Bool} \quad \compeq{e_1}{e_1'}{A} \quad \compeq{e_2}{e_2'}{A}}{\compeq{\boolElim{e}{e_1}{e_2}}{\boolElim{e'}{e_1'}{e_2'}}{A}}$
...
\begin{center}
  ...
  $\infrule[Rec-Zero]{\typing{z}{A} \quad \typing{s}{\Fun{A}{A}}}{\compeq{\elimNat{z}{s}{\zero}}{z}{A}}$

  \vspace{1em}

  $\infrule[Rec-Succ]{\typing{z}{A} \quad \typing{s}{\Fun{A}{A}} \quad \typing{n}{\Nat}}{\compeq{\elimNat{z}{s}{(\succ[n])}}{\app{s}{(\elimNat{z}{s}{n})}}{A}}$
...
\begin{center}
  ...
  $\infrule[Nat-Elim-Congr]{\compeq{z}{z'}{A} \quad \compeq{s}{s'}{\Fun{A}{A}} \quad \compeq{n}{n'}{\Nat}}{\compeq{\elimNat{z}{s}{n}}{\elimNat{z'}{s'}{n'}}{A}}$
\end{center}
...
\begin{center}
  ...
  $\infrule[Fold-Nil]{\typing{n}{B} \quad \typing{c}{\Fun{A}{\Fun{B}{B}}}}{\compeq{\elimList{n}{c}{\nil}}{n}{B}}$

  \vspace{1em}

  $\infrule[Fold-Cons]{\typing{n}{B} \quad \typing{c}{\Fun{A}{\Fun{B}{B}}} \quad \typing{h}{A} \quad \typing{t}{\List{A}}}{\compeq{\elimList{n}{c}{(\cons{h}{t})}}{\app{\app{c}{h}}{(\elimList{n}{c}{t})}}{B}}$
...
\begin{center}
  ...
  $\infrule[List-Elim-Congr]{\compeq{n}{n'}{A} \quad \compeq{c}{c'}{\Fun{A}{\Fun{B}{B}}} \quad \compeq{l}{l'}{\List{A}}}{\compeq{\elimList{n}{c}{l}}{\elimList{n'}{c'}{l'}}{B}}$
\end{center}
...
\begin{center}
  ...
  $\infrule[Hd-Scons]{\typing{a}{A} \quad \typing{f}{\Fun{A}{A}}}{\compeq{\hd[(\introStream{a}{f})]}{a}{A}}$

  \vspace{1em}

  $\infrule[Tl-Scons]{\typing{a}{A} \quad \typing{f}{\Fun{A}{A}}}{\compeq{\tl[(\introStream{a}{f})]}{\introStream{(\app{f}{a})}{f}}{\AxiStream{A}}}$
\end{center}
...
\begin{center}
  ...
  $\infrule[Scons-Congr]{\compeq{a}{a'}{A} \quad \compeq{f}{f'}{\Fun{A}{A}}}{\compeq{\introStream{a}{f}}{\introStream{a'}{f'}}{\AxiStream{A}}}$
...
\begin{itemize}
  ...
  \item $\compeq{\app{\app{\comp}{f}}{\id}}{f}{\Fun{A}{B}}$
  \item $\compeq{\app{\app{\comp}{\id}}{g}}{g}{\Fun{B}{C}}$
...
\begin{center}
  $\infrule[App-Lam-Def]{\fullcompeq{\extenddef{\Gamma}{x}{A}{a}}{b}{b'}{B}}{\compeq{\app{(\fun{x}{b})}{a}}{b'}{B}}$

  \vspace{1em}

  $\infrule[Let-Comp-Def]{\fullcompeq{\extenddef{\Gamma}{x}{A}{e_1}}{e_2}{e_2'}{B}}{\compeq{\letin{x}{e_1}{e_2}}{e_2'}{B}}$
\end{center}
...
\begin{center}
  $\infrule[Ctx-Extend]{\ctx{\Gamma} \quad \type{A} \quad \sidecond{x \notin \Gamma}}{\ctx{\extend{\Gamma}{x}{A}}}$
\end{center}
...
\begin{center}
  ...
  $\infrule[Refinement-Comp]{\fulltyping{\Gamma \pipe \Delta}{e}{A} \quad \holds{P}}{\compeq{\unrefine{(\refine{e})}}{e}{A}}$

  \vspace{1em}

  $\infrule[Refinement-Uniq]{\fulltyping{\Gamma \pipe \Delta}{e}{\refinement{x}{A}{P}}}{\compeq{e}{\refine{(\unrefine{e})}}{\refinement{x}{A}{P}}}$
...
\begin{center}
  ...
  $\infrule[Quotient-Comp]{\fulltyping{\Gamma \pipe \Delta}{e}{A} \quad \fulltyping{\Gamma \pipe \Delta}{f}{\Fun{A}{B}} \quad \mathcolor{red}{f\ \texttt{preserves}\ R}}{\compeq{\qout{f}{(\qin{e})}}{\app{f}{e}}{B}}$
\end{center}
