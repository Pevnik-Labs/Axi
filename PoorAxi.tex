...
\begin{center}
  ...
  $\infrule[Variant-Comp]{\typing{e}{A_j} \quad \typing{r}{\recordtype{c_i : \Fun{A_i}{B}}_{i \in I}} \quad \sidecond{j \in I}}{\computation{\vcase{(\app{c_j}{e})}{r}}{\app{\proj{c_j}{r}}{e}}{B}}$
\end{center}
...
\begin{center}
  ...
  $\infrule[Variant-Elim-Congr]{\computation{e}{e'}{\varianttypes{c}{A}{i}{I}} \quad \computation{r}{r'}{\recordtype{c_i : \Fun{A_i}{B}}_{i \in I}}}{\computation{\vcase{e}{r}}{\vcase{e'}{r'}}{B}}$
\end{center}
