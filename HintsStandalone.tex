...
% Pipes - used when specifying grammars in BDNF format.
\newcommand{\pipe}{\ |\ }
...
\newcommand{\compstep}[2]{#1 \longrightarrow #2}
\newcommand{\compsteps}[2]{#1 \longrightarrow^* #2}
\newcommand{\result}[2]{#1 \Downarrow #2}
...
% Commands for coloring differences in terms syntax between calculi.
...
\begin{center}
  $\infrule{}{\result{\fun{x}{e}}{\fun{x}{e}}}$ \quad
  $\infrule{\result{e_1}{\fun{x}{e}} \quad \result{e_2}{v} \quad \result{\subst{e}{x}{v}}{v'}}{\result{\app{e_1}{e_2}}{v'}}$

  \vspace{2em}

  $\infrule{\result{e_1}{v_1} \quad \result{e_2}{v_2}}{\result{\pair{e_1}{e_2}}{\pair{v_1}{v_2}}}$ \quad
  $\infrule{\result{e}{\pair{v_1}{v_2}}}{\result{\outl{e}}{v_1}}$ \quad
  $\infrule{\result{e}{\pair{v_1}{v_2}}}{\result{\outr{e}}{v_2}}$ \quad

  \vspace{2em}

  $\infrule{\result{e}{v}}{\result{\inl{e}}{\inl{v}}}$ \quad
  $\infrule{\result{e}{v}}{\result{\inr{e}}{\inr{v}}}$ \quad

  \vspace{2em}

  $\infrule{\result{e}{\inl{v}} \quad \result{\app{f}{v}}{v'}}{\result{\case{e}{f}{g}}{v'}}$ \quad
  $\infrule{\result{e}{\inr{v}} \quad \result{\app{g}{v}}{v'}}{\result{\case{e}{f}{g}}{v'}}$

  \vspace{2em}

  $\infrule{}{\result{\unit}{\unit}}$ \quad
\end{center}
...
\begin{center}
  $\infrule{\val{v}}{\compstep{\app{(\fun{x}{e})}{v}}{\subst{e}{x}{v}}}$

  \vspace{2em}

  $\infrule{\val{v_1} \quad \val{v_2}}{\compstep{\outl{\pair{v_1}{v_2}}}{v_1}}$ \quad
  $\infrule{\val{v_1} \quad \val{v_2}}{\compstep{\outr{\pair{v_1}{v_2}}}{v_2}}$

  \vspace{2em}

  $\infrule{\val{v}}{\compstep{\case{(\inl{v})}{f}{g}}{\app{f}{v}}}$

  \vspace{2em}

  $\infrule{\val{v}}{\compstep{\case{(\inr{v})}{f}{g}}{\app{g}{v}}}$
...
\begin{center}
  $\infrule{\compstep{e_1}{e_1'}}{\compstep{\app{e_1}{e_2}}{\app{e_1'}{e_2}}}$ \quad
  $\infrule{\val{v_1} \quad \compstep{e_2}{e_2'}}{\compstep{\app{v_1}{e_2}}{\app{v_1}{e_2'}}}$

  \vspace{2em}

  $\infrule{\compstep{e_1}{e_1'}}{\compstep{\pair{e_1}{e_2}}{\pair{e_1'}{e_2}}}$ \quad
  $\infrule{\val{v_1} \quad \compstep{e_2}{e_2'}}{\compstep{\pair{v_1}{e_2}}{\pair{v_1}{e_2'}}}$

  \vspace{2em}

  $\infrule{\compstep{e}{e'}}{\compstep{\outl{e}}{\outl{e'}}}$ \quad
  $\infrule{\compstep{e}{e'}}{\compstep{\outr{e}}{\outr{e'}}}$

  \vspace{2em}

  $\infrule{\compstep{e}{e'}}{\compstep{\inl{e}}{\inl{e'}}}$ \quad
  $\infrule{\compstep{e}{e'}}{\compstep{\inr{e}}{\inr{e'}}}$

  \vspace{2em}

  $\infrule{\compstep{e}{e'}}{\compstep{\case{e}{f}{g}}{\case{e'}{f}{g}}}$
...
$\result{e}{v}$ should be read ``term $e$ evalutes to value $v$''. It describes computation in a coarse-grained manner, telling us what is the result of evaluating each term. If $\result{e}{v}$, then $\val{v}$.

\vspace{2em}

$\compstep{e}{e'}$ should be read ``term $e$ reduces to term $e'$''. It describes computation in a fine-grained manner, telling us what can happen in a single computation step. To actually describe computation fully in this style, we need to take the transitive closure of this relation, written $\compsteps{e}{v}$.

\vspace{2em}

Both presented semantics are call-by-value, i.e. we evaluate a function's argument before performing a substitution. They are equivalent, i.e. $\result{e}{v}$ if and only if $\compsteps{e}{v}$
