...
\qquad $\pair{e_1}{e_2} \pipe \outl{e} \pipe \outr{e} \pipe$ \\
\qquad $\termdiff{\iinl{B}{e}} \pipe \termdiff{\iinr{A}{e}} \pipe \case{e}{e_1}{e_2} \pipe$ \\
\qquad $\unit \pipe \termdiff{\iemptyelim{A}{e}}$
...
\begin{center}
  ...
  $\infrule{\typing{e}{\Empty}}{\typing{\iemptyelim{A}{e}}{A}}$
\end{center}
...
\begin{center}
  ...
  $\infrule{\infer{e}{\Empty}}{\infer{\iemptyelim{A}{e}}{A}}$
\end{center}
...
\qquad $\pair{e_1}{e_2} \pipe \termdiff{\ioutl{B}{e}} \pipe \termdiff{\ioutr{A}{e}} \pipe$ \\
...
\begin{itemize}
  ...
  \item $\iemptyelim{A}{e} :\equiv \annot{\emptyelim{e}}{A}$
\end{itemize}
