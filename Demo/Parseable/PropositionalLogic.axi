...
// first introduced ?p.
theorem named-blocks-not-in-order-example :
  P --> Q --> P /\ Q
proof
  assume p q                           // p : P, q : Q |- P /\ Q
...
proof
  ...
  lemma implpp : P --> P by
    ...
    p                                  // Lemma proved!                // When we prove a lemma, the final message reflects it.
                                       // orpp : P \/ P, implpp : P --> P |- P
...
proof
  assume orpp                          // orpp : P \/ P |- P
  cases orpp ?implpp ?implpp           // Lemmas remaining: ?implpp : P --> P
  lemma implpp : P --> P by
    assume p                           // orpp : P \/ P, p : P |- P
...
proof
  ...
  . assume np : ~ P                    // npq : ~ P \/ Q, p : P, np : ~ P |- Q
    ...
    apply contradiction np p           // Goal solved!
                                       // npq : ~ P \/ Q, p : P |- Q --> Q
...
proof
  ...
  apply contradiction np p             // Theorem proved!
qed
...
proof
  ...
  both
                                       // pq : P --> Q, qp : Q --> P |- ~ P --> ~ Q
  . apply contraposition qp            // Goal solved!
                                       // pq : P --> Q, qp : Q --> P |- ~ Q --> ~ P
  . apply contraposition pq            // Theorem proved!
qed
...
proof
  ...
  . assume q                           // np : ~ P, nq : ~ Q, npq : P \/ Q, q : Q |- False
    apply contradiction nq q           // Theorem proved!
qed
